...
let titleContent = ` Qué Figura es esta?`;
let boxesSize = 100;
...
//array of words
let commonWords = ['Circulo', 'Corazón', 'Cruz', 'Cuadrado', 'Elipse', 'Estrella', 'Flecha',
'Rectángulo', 'Rombo', 'Trapecio', 'Triángulo', 'Cubo'];
...
//Sounds effects
let rightAnswer = new Audio('../../music/geometric-shapes/Correct Answer - Sound Effect.mp3');
let wrongAnswer = new Audio('../../music/geometric-shapes/Wrong Clakson Sound Effect.mp3');
let victory = new Audio('../../music/geometric-shapes/applause3.mp3');
...
function restart(){
	...
	if(score < maxScore){
		...
		makeBoxes(emptyStringWithLength(word), emptyBoxesSize, boxesX, emptyBoxesY, '#8cccf6', 'none', false);
		draw();
		image.onload = () =>{
 ...
 */
 ...
 function restartGame(){
	...
	commonWords = ['Circulo', 'Corazón', 'Cruz', 'Cuadrado', 'Elipse', 'Estrella', 'Flecha',
    'Rectángulo', 'Rombo', 'Trapecio', 'Triángulo', 'Cubo'];
	theEnd = false;
	score = 0;
	n = 0;
...
function chooseImg( wordToCheck ){
	let img = new Image();
	img.src = `../../images/geometric-shapes/${wordToCheck}.png`;
	return img;
}
...
function chooseSound( wordToCheck ){
	let sound = new Audio();
	sound.src = `../../music/geometric-shapes/${wordToCheck}.mp3`;
	return sound;
}
